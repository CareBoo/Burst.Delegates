...
<root>
  ...
  ├── Editor
  │   ├── CareBoo.Burst.Delegates.Editor.asmdef
  │   └── EditorExample.cs
  ├── Runtime
  │   ├── CareBoo.Burst.Delegates.asmdef
  │   └── RuntimeExample.cs
  ├── Tests
  │   ├── .tests.json
  │   ├── Editor
  │   │   ├── CareBoo.Burst.Delegates.Editor.Tests.asmdef
  │   │   └── EditorExampleTest.cs
  │   └── Runtime
  │        ├── CareBoo.Burst.Delegates.Tests.asmdef
...
1. Enter your package name. The name you choose should contain your default organization followed by the name you typed. For example: `CareBoo.Burst.Delegates`.
...
To use the Inspector, select the `package.json` file in the Project browser. The **Package My Package Manifest** page opens for editing.
...
* Store Editor-specific code under a root editor assembly definition file:
  ...
  `Editor/CareBoo.Burst.Delegates.Editor.asmdef`

* Store runtime-specific code under a root runtime assembly definition file:

  `Runtime/CareBoo.Burst.Delegates.asmdef`

* Configure related test assemblies for your editor and runtime scripts:

  `Tests/Editor/CareBoo.Burst.Delegates.Editor.Tests.asmdef`

  `Tests/Runtime/CareBoo.Burst.Delegates.Tests.asmdef`
...
Use the `Documentations~/My Package.md` documentation file to create preliminary, high-level documentation. This document should introduce users to the features and sample files included in your package.  Your package documentation files will be used to generate online and local docs, available from the Package Manager UI.
